...
# Uboot defconfig
export RK_UBOOT_DEFCONFIG=vivid
# RK_UBOOT_DEFCONFIG_FRAGMENT Have bugs
#export RK_UBOOT_DEFCONFIG_FRAGMENT=vivid
# Kernel defconfig
export RK_KERNEL_DEFCONFIG=vivid_unit_has_defconfig
# Kernel dts
export RK_KERNEL_DTS=rk3399-vivid-unit-has-v13
# boot image type
export RK_BOOT_IMG=boot.img
# kernel image path
export RK_KERNEL_IMG=kernel/arch/arm64/boot/Image
# parameter for GPT table
export RK_PARAMETER=parameter-no-userdata-oem.txt
# package file
export RK_PACKAGE_FILE=rk3399-package-file-no-userdata-oem
# Buildroot config
export RK_CFG_BUILDROOT=rockchip_rk3399
# Recovery config
export RK_CFG_RECOVERY=rockchip_vivid_recovery
# Pcba config
